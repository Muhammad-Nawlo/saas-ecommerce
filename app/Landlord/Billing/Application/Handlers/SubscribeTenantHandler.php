...
final readonly class SubscribeTenantHandler
{
    ...
    public function __invoke(SubscribeTenantCommand $command): Subscription
    {
        return $this->transactionManager->run(fn () => $this->billingService->subscribeTenant($command));
    }
}
