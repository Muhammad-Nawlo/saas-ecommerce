...
final readonly class SetLowStockThresholdHandler
{
    ...
    public function __invoke(SetLowStockThresholdCommand $command): void
    {
        $this->transactionManager->run(function () use ($command): void {
            ...
            $stock->setLowStockThreshold($command->threshold);
